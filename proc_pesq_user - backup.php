...
$result_user = "SELECT dataDaCompra,comercio,setor,produto,marca,quantidade,precoKg,precoUnidade,valorTotal FROM compra";
...
$result_usuarios = "SELECT dataDaCompra,comercio,setor,produto,marca,quantidade,precoKg,precoUnidade,valorTotal FROM compra WHERE 1=1";
if( !empty($requestData['search']['value']) ) {   // se houver um parâmetro de pesquisa, $requestData['search']['value'] contém o parâmetro de pesquisa
	$result_usuarios.=" AND ( comercio LIKE '".$requestData['search']['value']."%' ";    
